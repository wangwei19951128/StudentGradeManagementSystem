...
public class AdminStudentClassInfoWindow extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3519868134622024595L;
		...
		contentPanel.add(comboBox_1);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(e -> {
					...
					try {
						Main.databaseConnection.addStudentClassInfo(username, classId);
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
