...
public class MainWindow {
	...
	private void initialize() {
		...
		lblXxxxxxxxxxxx.setFont(new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 50));
		...
		label.setFont(new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 50));
		...
		btnNewButton.setFont(new Font("Î¢ÈíÑÅºÚ Light", Font.BOLD, 30));
		...
		btnNewButton_1.setFont(new Font("Î¢ÈíÑÅºÚ Light", Font.BOLD, 30));
