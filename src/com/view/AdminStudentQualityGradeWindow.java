			...
			getContentPane().add(buttonPane);
			{
				...
				okButton.addActionListener(e -> {
					...
					try {
						...
						studentQualityGrade.setGrade(0, 3, Float.parseFloat(textField_2.getText())+Float.parseFloat(textField_3.getText())+Float.parseFloat(textField_4.getText()));
						studentQualityGrade.setGrade(1, 3, Float.parseFloat(textField_5.getText())+Float.parseFloat(textField_6.getText())+Float.parseFloat(textField_7.getText()));
						studentQualityGrade.setGrade(2, 3, Float.parseFloat(textField_8.getText())+Float.parseFloat(textField_9.getText())+Float.parseFloat(textField_10.getText()));
						studentQualityGrade.setGrade(3, 3, Float.parseFloat(textField_11.getText())+Float.parseFloat(textField_12.getText())+Float.parseFloat(textField_13.getText()));
						studentQualityGrade.setGrade(4, 3, Float.parseFloat(textField_15.getText())+Float.parseFloat(textField_16.getText())+Float.parseFloat(textField_17.getText()));
						studentQualityGrade.setGrade(5, 3, Float.parseFloat(textField_18.getText())+Float.parseFloat(textField_19.getText())+Float.parseFloat(textField_20.getText()));
						studentQualityGrade.setGrade(6, 3, Float.parseFloat(textField_21.getText())+Float.parseFloat(textField_22.getText())+Float.parseFloat(textField_23.getText()));
						studentQualityGrade.setGrade(7, 3, Float.parseFloat(textField_24.getText())+Float.parseFloat(textField_25.getText())+Float.parseFloat(textField_26.getText()));
						studentQualityGrade.setGrade(8, 3, Float.parseFloat(textField_28.getText())+Float.parseFloat(textField_29.getText())+Float.parseFloat(textField_30.getText()));
						studentQualityGrade.setGrade(9, 3, Float.parseFloat(textField_31.getText())+Float.parseFloat(textField_32.getText())+Float.parseFloat(textField_33.getText()));
						studentQualityGrade.setGrade(10, 3, Float.parseFloat(textField_34.getText())+Float.parseFloat(textField_35.getText())+Float.parseFloat(textField_36.getText()));
						studentQualityGrade.setGrade(11, 3, Float.parseFloat(textField_37.getText())+Float.parseFloat(textField_38.getText())+Float.parseFloat(textField_39.getText()));

						float moduleGrade0 = studentQualityGrade.getGrade()[0][3]+studentQualityGrade.getGrade()[1][3]+studentQualityGrade.getGrade()[2][3]+studentQualityGrade.getGrade()[3][3];
...
//								+ Float.parseFloat(textField.getText())) / 4;
						...
						float moduleGrade1 = studentQualityGrade.getGrade()[4][3]+studentQualityGrade.getGrade()[5][3]+studentQualityGrade.getGrade()[6][3]+studentQualityGrade.getGrade()[7][3];
...
//								+ Float.parseFloat(textField_43.getText())) / 4;
						...
						float moduleGrade2 = studentQualityGrade.getGrade()[8][3]+studentQualityGrade.getGrade()[9][3]+studentQualityGrade.getGrade()[10][3]+studentQualityGrade.getGrade()[11][3];
